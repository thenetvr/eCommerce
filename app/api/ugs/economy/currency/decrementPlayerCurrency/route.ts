...
export async function POST(req: Request) {
  ...
  await fetch("https://economy.services.api.unity.com/v2/projects/"+ process.env.PROJECT_ID +"/players/"+playerId+"/currencies/"+ currencyId+"/decrement", requestOptions as object)
