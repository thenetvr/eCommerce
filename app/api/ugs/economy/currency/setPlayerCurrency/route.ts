...
export async function PUT(req: Request) {
  ...
  var raw = JSON.stringify({
    "balance": Number(headers().get("balance")),
  ...
  await fetch("https://economy.services.api.unity.com/v2/projects/"+ process.env.PROJECT_ID +"/players/"+playerId+"/currencies/"+ currencyId, requestOptions as object)
