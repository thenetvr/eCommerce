...
import pic from './NetVR Ecommerce platform.png'
    ...
    return (
        ...
        <div className="bg-gradient-to-br from-[#1C1D2C] to-[#0022D4] h-72 shadow-lg drop-shadow-lg"  >
            ...
            <div className="flex ml-4 mt-16 [&>*]:ml-2">
                <Image alt={"test"} src={"/icon1.png"} width={"20"} height={"20"}></Image>
                <Image alt={"test"} src={"/icon2.png"} width={"20"} height={"20"}></Image>
                <Image alt={"test"} src={"/icon3.png"} width={"20"} height={"20"}></Image>
            </div>
